...
### `@ui-ux-designer` — UI/UX デザイン

**いつ使う？**

- ソフトグローグラデーションのデザインシステムに沿った UI を実装したいとき
- コンポーネントのスタイルをレビュー・改善したいとき
- UX（アクセシビリティ・レスポンシブ・ローディング状態等）を確認したいとき
- ダークモード対応を追加・修正したいとき

**何をしてくれる？**

1. 既存コンポーネントのスタイルを分析し、改善点を提案
2. ソフトグローグラデーションのデザインシステムに基づくスタイル実装
3. UX チェックリスト（インタラクション・フィードバック・レスポンシブ・アクセシビリティ・ダークモード）に沿った検証
4. Tailwind CSS ユーティリティを活用した効率的なスタイリング

**使い方の例:**

```text
@ui-ux-designer サイドバーにソフトグローグラデーションを適用してください
```

```text
@ui-ux-designer ログイン画面のUXを改善してください
```

```text
@ui-ux-designer 全コンポーネントのダークモード対応を確認してください
```
